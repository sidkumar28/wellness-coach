...
class databasewc extends SQLiteOpenHelper{
    ...
    private static final String DATABASE_NAME="WellnessCoach.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query="CREATE TABLE "+ TABLE_NAME +
                    " ("+ COLUMN_NAME + " TEXT, " +
                COLUMN_MOBILE + " INTEGER PRIMARY KEY, "+
                COLUMN_CITY + " TEXT, "+
                COLUMN_AGE + " INTEGER, "+
    ...
    void addCustomer(String n, int m, String c, int a, int w, int iw, int e, int l, int bf, int vf, int rm, int bmi, int ba, int wbs, int tf, int af, int lf, int sm, int tm, int am, int lm){
